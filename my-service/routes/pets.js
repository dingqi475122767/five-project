...
const {addPets,getPetsByPage,removePets,updatePets,getPetsByPageWX} = require('../service/petsService');
...
router.post('/getPetsByPage',async function(req, res, next) {
 ...
 router.post('/getPetsByPageWX',async function(req, res, next) {
  res.send(await getPetsByPageWX(req.body));
 });
